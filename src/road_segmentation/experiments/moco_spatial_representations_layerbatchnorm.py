...
EXPERIMENT_DESCRIPTION = 'MoCo Spatial Representations Only - Using Layer Batch Norm'
EXPERIMENT_TAG = 'moco_spatial_representations_layer_batchnorm'


def main():
    MoCoSpatialRepresentationsExperimentLayerBatchNorm().run()


class MoCoSpatialRepresentationsExperimentLayerBatchNorm(
