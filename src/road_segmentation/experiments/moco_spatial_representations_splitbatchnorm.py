...
EXPERIMENT_DESCRIPTION = 'MoCo Spatial Representations Only - Using Split Batch Normalization'
EXPERIMENT_TAG = 'moco_spatial_representations_split_batchnorm'


def main():
    MoCoSpatialRepresentationsExperimentSplitBatchNorm().run()


class MoCoSpatialRepresentationsExperimentSplitBatchNorm(
    ...
    def _construct_backbone(self, name: str) -> tf.keras.Model:
        ...
        normalization_builder = rs.util.SplitBatchNormalizationBuilder()
