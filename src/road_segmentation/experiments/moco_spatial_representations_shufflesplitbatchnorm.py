...
EXPERIMENT_DESCRIPTION = 'MoCo Spatial Representations Only - Using Shuffle Split Batch Normalization'
EXPERIMENT_TAG = 'moco_spatial_representations_shuffle_split_batchnorm'


def main():
    MoCoSpatialRepresentationsExperimentShuffleSplitBatchNorm().run()


class MoCoSpatialRepresentationsExperimentShuffleSplitBatchNorm(
    ...
    def _construct_backbone(self, name: str) -> tf.keras.Model:
        ...
        normalization_builder = rs.util.ShuffleSplitBatchNormalizationBuilder()
